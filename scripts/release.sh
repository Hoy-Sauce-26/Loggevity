...
mv build/app/outputs/flutter-apk/app-release.apk build/app/outputs/flutter-apk/loggevity_"$VERSION_NAME".apk
...
echo "Done — v$VERSION_NAME (build $BUILD_NUMBER) at build/app/outputs/flutter-apk/loggevity_${VERSION_NAME}.apk"
