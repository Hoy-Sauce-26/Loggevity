...
///
/// Out-of-range inputs are **clamped** to the terminal `y` values.
/// Extrapolating along the final segment instead produces unbounded penalties
/// (300 min of resistance training would score -25.25 rather than -9.0), so
/// the curves are treated as
